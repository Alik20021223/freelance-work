...
const Sidebar = () => {
    ...
    return (
        <aside className={`bg-white sticky inset-y-12 transition-all duration-100 ease-in-out left-0 overflow-hidden h-[calc(100vh-50px)] ${open ? `w-[340px]` : `w-[72px]`} border-rborder-neutral-100 text-white`}>
