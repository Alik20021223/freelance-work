...
const Sidebar = () => {
    ...
    return (
        <aside className={`bg-white sticky inset-y-12 transition-all duration-100 ease-in-out left-0 overflow-hidden h-screen ${open ? `w-[340px]` : `w-[72px]`} pt-[60px] border-r border-neutral-100 text-white`}>
